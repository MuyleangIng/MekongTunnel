...
func (s *Server) HandleSSHConnection(conn net.Conn) {
	...
	urlMessage := "\r\n" +
		...
		gray + "  ─────────────────────────────────────────" + reset + "\r\n" +
		gray + "  Server   " + purple + s.domain + reset + "\r\n" +
		gray + "  Expires  " + purple + expiry.Format(tun.InactivityTimeout()) + reset + "\r\n" +
		gray + "  Tips     " + cyan + "Ctrl+C" + reset + gray + " stop | " + cyan + "mekong status" + reset + gray + " | " + cyan + "mekong logs" + reset + "\r\n" +
		gray + "  ─────────────────────────────────────────" + reset + "\r\n" +
		"\r\n" +
