...
```bash
sudo curl -L https://github.com/MuyleangIng/MekongTunnel/releases/download/v1.2.0/mekong-darwin-arm64 -o /usr/local/bin/mekong
...
```bash
sudo curl -L https://github.com/MuyleangIng/MekongTunnel/releases/download/v1.2.0/mekong-darwin-amd64 -o /usr/local/bin/mekong
sudo chmod +x /usr/local/bin/mekong
xattr -d com.apple.quarantine /usr/local/bin/mekong
mekong 3000
```
...
```bash
sudo curl -L https://github.com/MuyleangIng/MekongTunnel/releases/download/v1.2.0/mekong-linux-amd64 -o /usr/local/bin/mekong
sudo chmod +x /usr/local/bin/mekong
mekong 3000
```
...
```bash
sudo curl -L https://github.com/MuyleangIng/MekongTunnel/releases/download/v1.2.0/mekong-linux-arm64 -o /usr/local/bin/mekong
sudo chmod +x /usr/local/bin/mekong
mekong 3000
```
...
Download [`mekong-windows-amd64.exe`](https://github.com/MuyleangIng/MekongTunnel/releases/download/v1.2.0/mekong-windows-amd64.exe), rename it to `mekong.exe`, and add it to your PATH. Then run `mekong 3000`.
